...
contract PhotoAlbum is ERC721, ERC721URIStorage, AutomationCompatibleInterface {
    ...
    string[] IpfsUri = [
    "https://turquoise-rear-loon-357.mypinata.cloud/ipfs/QmQJ4FVPrKoUSmnyM72nJeEFJv5CGXsXagjc32bt9i8SHS/1.json",
    "https://turquoise-rear-loon-357.mypinata.cloud/ipfs/QmQJ4FVPrKoUSmnyM72nJeEFJv5CGXsXagjc32bt9i8SHS/2.json",
    "https://turquoise-rear-loon-357.mypinata.cloud/ipfs/QmQJ4FVPrKoUSmnyM72nJeEFJv5CGXsXagjc32bt9i8SHS/3.json"
    ];

    uint public immutable interval;
    uint public lastTimeStamp;

    constructor(uint updateInterval) ERC721("Photo Album - Chainlink Bootcamp 2024", "NAWO") {
